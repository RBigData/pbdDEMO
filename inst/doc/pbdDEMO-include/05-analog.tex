...
written in batch by using \pkg{pbdDEMO}.  Each time, we first give the
version using \pkg{parallel} followed by the
version using \pkg{pbdDEMO}. All codes are available in
\code{pbdDEMO/inst/examples/test_parallel/}. \\
...
Intel(R) Core(TM) i5-2410M CPU @ 2.30 GHz, xubuntu 11.04 system,
and OpenMPI 1.6. \pkg{pbdDEMO} performs better than \pkg{snow} in this
