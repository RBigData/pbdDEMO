...
% spmd methods
\input{./pbdDEMO-include/part_1}
\input{./pbdDEMO-include/02-statistics}
% ddmatrix methods
\input{./pbdDEMO-include/part_2}
\input{./pbdDEMO-include/03-gen}
\input{./pbdDEMO-include/04-reading}
\input{./pbdDEMO-include/05-dmat_stats}
% appendices
