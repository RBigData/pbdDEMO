...
\code{pbdDEMO/inst/examples/test_rmpi}. Here, we only show a simple
comparison of \pkg{pbdDEMO} to \pkg{Rmpi}.  The two scripts are
equivalent for \pkg{pbdDEMO} and \pkg{Rmpi}.  We run them with two
...
and OpenMPI 1.6.
The \pkg{pbdDEMO} is more efficient than \pkg{Rmpi} with
