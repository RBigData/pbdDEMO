...
The \code{iris}~\citep{Fisher1936}~\index{iris} dataset is a famous dataset
...
\section{{\it Iris} in Serial Code and Sample Outputs}
...
\section{{\it Iris} in \code{ddmatrix}\ Code}
