...
\title{\Huge Programming with Big Data in \proglang{R}\\[.3cm]
{\LARGE Package Examples and Demonstrations}}
...
\input{./pbdDEMO-include/02.25-batch}
% spmd methods
...
\input{./pbdDEMO-include/07-dmat_stats}
% appendices
