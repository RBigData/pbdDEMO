...
%
Drew Schmidt\\
{\small\emph{National Institute for Computational Sciences,\\
University of Tennessee, Knoxville, TN, USA}}\\[.4cm]
%%%
Wei-Chen Chen\\
...
\input{./pbdDEMO-include/frontmatter/00-copyright}
...
\fancyhf[C]{}
\phantomsection
\input{./pbdDEMO-include/frontmatter/00-acknowledgement}

\newpage
\fancyhf[C]{}
\phantomsection
\input{./pbdDEMO-include/frontmatter/00-warn}
