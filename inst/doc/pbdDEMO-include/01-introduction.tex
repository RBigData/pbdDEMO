...
The ``Programming with Big Data in R'' project~\citep{pbdR2012} (pbd or pbdR for short) is a project that aims to take the statistical programming language \proglang{R}~\citep{Rcore}.
