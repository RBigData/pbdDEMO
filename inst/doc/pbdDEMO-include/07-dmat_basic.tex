...
\code{svd()}/\code{La.svd()},~\index{\code{svd()}}\index{\code{La.svd()}}
QR factorization \code{qr()},~\index{\code{qr()}}
Cholesky factorization \code{chol()},~\index{Cholesky factorization}\index{\code{chol()}}
and LU factorization \code{lu()}.~\index{LU factorization}\index{\code{lu()}}
So for example:
